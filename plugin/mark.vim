...
if &t_Co < 256
	...
	exec "hi MarkWord5 guifg=White ctermfg=White guibg=#FF0000 ctermbg=".s:RGB(5,1,2)
	exec "hi MarkWord6 guifg=White ctermfg=White guibg=#0087FF ctermbg=".s:RGB(0,2,5)
endif
